const ButtonSvg = (white) => (
  <>
    ...
    >
      <path
        fill={white ? "#FFFFED" : "none"}
        stroke={white ? "url(#btn-left)" : "url(#btn-left)"} // mentioned in ButtonGradient.jsx
        strokeWidth="2"
    ...
    >
      <path
        fill={white ? "#FFFFED" : "none"}
        stroke={white ? "url(#btn-right)" : "url(#btn-right)"} // mentioned in ButtonGradient.jsx
        strokeWidth="2"
